    ...
    <div class="upload">
        ...
        <form action="./crud/save.php" method="post" id="form" enctype="multipart/form-data">
            <label for="title">Titulo / Nombre
                <input placeholder="Titulo de la pelicula" type="text" id="title" name="title">
            </label>
            <label for="description">Sinopsis
                <textarea placeholder="Sinopsis de la pelicula" type="text" id="description" name="description"></textarea>
            </label>
            ...
            <label for="duracion">Duracion<input value="01:00" type="time" id="duracion" name="duracion"></label>
